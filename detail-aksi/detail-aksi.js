...
// Menambahkan event listener pada tombol "Ikuti Aksi"
document.getElementById("aksi-button").addEventListener("click", function () {
  // Menampilkan pop-up "Anda mengikuti aksi"
  alert("Anda Berhasil Mengikuti Aksi");
});
